...
server.registerTool("list_repos", {
    description: "List GitHub repositories for a user. If no username is provided, lists the authenticated user's repos including private ones.",
    inputSchema: {
    ...
    try {
        ...
        const text = data
            .map((r) => `${r.private ? "[private]" : "[public]"} ${r.full_name}\n` +
